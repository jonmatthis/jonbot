...
from golembot.layer0_frontends.discord_bot.event_handlers.handle_text_message import \
    update_conversation_history_in_database
from golembot.layer1_api_interface.app import get_api_endpoint_url, VOICE_TO_TEXT_ENDPOINT
from golembot.layer1_api_interface.send_request_to_api import send_request_to_api
from golembot.layer3_data_layer.data_models.voice_to_text_request import VoiceToTextRequest
