...
from golembot.layer3_data_layer.data_models.ai_chatbot_models import VectorStoreMemoryConfig
...
class ChatbotVectorStoreMemoryBuilder(VectorStoreRetrieverMemory):
    ...
    async def build(cls,
        ...
        chroma_vector_store = await cls._create_vector_store(**vector_store_config.dict())
    ...
    @staticmethod
    async def _create_vector_store(collection_name: str,
                                   persistence_path: str) -> VectorStore:
        return Chroma(
