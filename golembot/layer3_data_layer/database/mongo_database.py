...
from golembot.layer3_data_layer.data_models.conversation_models import ConversationHistory, ContextRoute
from golembot.layer3_data_layer.data_models.user_id_models import TelegramID, DiscordID, UserID
from golembot.layer3_data_layer.system.filenames_and_paths import clean_path_string, get_default_database_json_save_path
from golembot.layer3_data_layer.utilities.default_serialize import default_serialize

logger = logging.getLogger(__name__)

DATA_COLLECTION_NAME = "golembot_collection"
USERS_COLLECTION_NAME = "golembot_users"
CONVERSATION_HISTORY_COLLECTION_NAME = "conversation_history"
DATABASE_NAME = "golembot_database"
