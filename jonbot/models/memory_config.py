...
from jonbot.layer2_processing.ai.chatbot.components.memory.conversation_memory.conversation_summary_prompt_templates import (
...
class ChatbotConversationMemoryConfig(BaseModel):
    ...
    summary_prompt: PromptTemplate = DEFAULT_CONVERSATION_SUMMARY_PROMPT
...
class VectorStoreMemoryConfig(BaseModel):
    ...
    def from_database_name(cls, database_name: str):
        return cls(
            collection_name=database_name.split("_")[0] + "_vectorstore",
