...
from jonbot.backend.data_layer.models.conversation_models import ConversationContextDescription
...
class ChatbotPrompt(ChatPromptTemplate):
    ...
    def build(
        ...
        partial_system_prompt = system_prompt.partial(
            ...
            context_route=conversation_context.context_route.parent
            if conversation_context
            else "",
            context_description=conversation_context.description
            if conversation_context
            else "",
        )
