...
async def document_from_channel(database_name: str = "classbot_database",
                                query: Dict = None,
...
if __name__ == "__main__":
    asyncio.run(document_from_channel(query={"server_id": 1150736235430686720,
                                             "channel_id": 1150736235430686720, }
                                      )
                )
