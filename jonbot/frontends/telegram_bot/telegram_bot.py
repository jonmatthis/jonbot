...
from jonbot.frontends.telegram_bot.handlers.telegram_chat import telegram_chat
from jonbot.system.environment_variables import TELEGRAM_BOT_TOKEN

try:
    from jonbot.frontends.telegram_bot.utilities.check_version_compatibility import (
        __version_info__,
    )
