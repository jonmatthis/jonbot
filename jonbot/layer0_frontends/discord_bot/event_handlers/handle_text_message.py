...
from jonbot.layer1_api_interface.app import API_CHAT_URL, API_DATABASE_UPSERT_URL, API_CHAT_STREAM_URL
...
async def handle_text_message(message: discord.Message,
    ...
    async with aiohttp.ClientSession() as session:
        ...
        if streaming:
            await send_streaming_chat_api_request(api_route=API_CHAT_STREAM_URL,
