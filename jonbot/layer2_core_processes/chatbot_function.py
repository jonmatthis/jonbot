...
from jonbot.layer2_core_processes.core.ai.chatbot_llm_chain.get_chatbot_llm_chain import \
...
async def chatbot_function(chat_request: ChatRequest) -> AsyncIterable[str]:
